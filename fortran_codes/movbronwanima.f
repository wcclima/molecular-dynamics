...
********************************************************
	 ...
	 if (yn(i).lt.0.d0) then
      ...
      write(*,6)"@S0 line type 0    "
      write(*,6)"@S0 symbol 1       "
      write(*,6)"@S0 symbol color 2 "
      write(*,6)"@S0 symbol size .3 "
      write(*,6)"&                  "
      ...
      write(*,*) xn(npat),yn(npat)

      write(*,6)"@S1 line type 0    "
      write(*,6)"@S1 symbol 1       "
      write(*,6)"@S1 symbol color 3 "
      write(*,6)"@S1 symbol size .3 "
      write(*,6)"&                  "
      write(*,6)"@redraw            "
      write(*,6)"@sleep 0.02        "
      write(*,6)"@kill S1           "
